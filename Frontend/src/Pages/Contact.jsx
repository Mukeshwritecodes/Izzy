  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Have a question, suggestion, or just want to share your latest reading adventure? We'd love to hear from you!
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#B787B6] focus:border-transparent"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows="6"
                    className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#B787B6] focus:border-transparent resize-vertical"
                ...
                <button
                  ...
                  className="w-full sm:w-auto bg-[#B787B6] hover:bg-[#A076A5] disabled:bg-gray-400 text-white font-semibold py-3 px-8 rounded-lg transition-colors duration-200"
                >
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                Step into our literary sanctuary where stories come alive and every book lover feels at home.
              </p>

              <div className="space-y-8">
                {contactInfo.map((info, index) => (
                  <div key={index} className="flex items-start space-x-4">
                    <div className="flex-shrink-0 w-12 h-12 bg-[#F27C66] rounded-full flex items-center justify-center text-white text-xl">
                      {info.icon}
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-[#1F1E3E] mb-2">
                        {info.title}
                      </h3>
          ...
          <div className="space-y-6">
            {faqItems.map((faq, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-sm">
                <h3 className="text-lg font-semibold text-[#1F1E3E] mb-3">
                  {faq.question}
                </h3>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-12 bg-gradient-to-r from-[#1F1E3E] to-[#B787B6] relative">
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-[#F8FBE6] opacity-90 mb-8">
            Connect with fellow book lovers, discover new authors, and share your reading journey with us.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="bg-transparent border-2 border-[#F8FBE6] text-[#F8FBE6] hover:bg-[#F8FBE6] hover:text-[#1F1E3E] font-semibold py-3 px-6 rounded-lg transition-colors duration-200">
              Join Our Newsletter
            </button>
          </div>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-12 bg-white relative">
        <img src={Branch} alt="Decorative branch" className="absolute bottom-8 left-8 w-28 h-28 opacity-20 transform rotate-12" />
        <div className="relative max-w-4xl mx-auto text-center">
