    ...
    <footer className="bg-[#1F1E3E] text-[#F8FBE6] px-6 py-10">
      <div className="max-w-4xl mx-auto flex flex-col items-center text-center gap-8">
        ...
        <div>
          <div className="mb-2">
            <span className="text-2xl font-semibold">
              ...
              <span className="text-white">Izzy</span>
            </span>
          </div>
          <p className="text-sm italic" style={{ color: "#F8AFAF" }}>
        ...
        <div>
          ...
          {showLinks && (
            <ul className="text-sm space-y-1">
              <li><a href="/" className="text-[#F8AFAF] hover:underline">Home</a></li>
              <li><a href="/catalog" className="text-[#F8AFAF] hover:underline">Best Sellers</a></li>
              <li><a href="/authors" className="text-[#F8AFAF] hover:underline">Authors</a></li>
            </ul>
          )}
        </div>
        ...
        <div>
          ...
          {showSupport && (
            <ul className="text-sm space-y-1">
              <li><a href="/contact" className="text-[#F8AFAF] hover:underline">Contact Us</a></li>
              <li><a href="/faq" className="text-[#F8AFAF] hover:underline">FAQs</a></li>
              <li><a href="/returns" className="text-[#F8AFAF] hover:underline">Shipping & Returns</a></li>
            </ul>
          )}
        </div>
